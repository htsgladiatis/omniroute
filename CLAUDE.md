...
9. Coverage must stay ≥40% (statements, lines, functions, branches). Gate lowered from 75/75/75/70 during plan 14 implementation per user instruction (2026-05-28).
