...
import { injectCreditsField, shouldRetryWithCredits, handleCreditsFailure } from "../services/antigravityCredits.ts";
              ...
              if (!retryMs) {
                ...
                if (
                  ...
                  shouldRetryWithCredits(
                    ...
                    process.env.ANTIGRAVITY_CREDITS === "1" || process.env.ANTIGRAVITY_CREDITS === "true"
                  )
                ) {
                  ...
                  try {
                    ...
                    if (creditsResp.ok || creditsResp.status !== HTTP_STATUS.RATE_LIMITED) {
                      ...
                      if (!stream) {
                        return this.collectStreamToResponse(creditsResp, model, url, headers, creditsBody, log, signal);
                      }
