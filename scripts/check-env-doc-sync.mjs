 ...
 *
 *  Usage:
 *    node scripts/check-env-doc-sync.mjs           # strict (CI mode)
 *    node scripts/check-env-doc-sync.mjs --lenient # legacy report-only mode
 *
...
function main() {
  ...
  console.log("  or the allowlists in scripts/check-env-doc-sync.mjs and try again.");
  process.exit(1);
}
